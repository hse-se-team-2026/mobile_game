...
|-----------|----------|------------|
| Фоновые иллюстрации (webp) | Nano Banana | 12 сцен: таверна, порт, библиотека, храм, рынок и т.д. |
| Нарративные тексты | Gemini 2.5 Pro | Структурирование и расширение сюжетных сцен, 48 JSON-файлов |
